/*
 * RGB LED Controller for ESP32-C3 Super Mini
 ...
 *   2. BLE - Use the Android app (search for "RGB-LED-Controller")
 *   3. WiFi - Connect to "RGB-LED" network, open http://192.168.4.1
 */
...
void setupBLE() {
  ...
  // Mode characteristic (1 byte: 0=normal, 1=pulse, 2=strobe)
  ...
  Serial.println("BLE advertising started - look for 'RGB-LED-Controller'");
}
...
void setup() {
  ...
  Serial.println("Control via:");
  Serial.println("  - Button 1 (GPIO4): Long press=On/Off, Short press=Mode");
  Serial.println("  - Button 2 (GPIO5): Short press=Color cycle");
  Serial.println("  - WiFi: Connect to 'RGB-LED' (pass: 12345678), open http://192.168.4.1");
  Serial.println("  - BLE: Search for 'RGB-LED-Controller' in the app");
}
